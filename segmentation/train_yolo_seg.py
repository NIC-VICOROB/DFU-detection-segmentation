...
def train(config='yolo_baseline', epochs=200, lr0=0.001, patience=20, imgsz=640, output_dir='weights/yolo_seg'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='weights/yolo_seg')
